...
export const UserCard = ({
  ...
  return (
    <div className='flex max-w-[200px] cursor-pointer flex-col items-center justify-center gap-2 rounded-lg border p-2 shadow-md shadow-violet-100 hover:border-violet-500 hover:ring hover:ring-violet-300 hover:ring-offset-1'>
